...
<html>
    <head>
        <title>Consulta e listatem - hóspede</title>
        <meta charset="UTF-8">
        ...
        <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center" id="template-bg-3">
            <div class="card mb-5 p-5 bg-gradient text-white col-md-4 formlogin">
                <div class="card-header text-center">
                    <h3>Consulta e listagem - Hóspede</h3>
                </div>
                <table>
                    ...
                    <tbody>
                        <?php
                        $resultado = consulta_hospede();
                        //   var_dump($resultado);
                        foreach ($resultado as $linha) {
                            ?>
                            <tr>
                                <td><?= $linha['id_hosp'] ?></td>
                                <td><?= $linha['nome_hosp'] ?></td>
                                <td><?= $linha['cpf_hosp'] ?></td>
                                <td>
                                    ...
                                    <a href="cadastro.php?id_hosp=<?= $linha['id_hosp'] ?>" class="btn btn-warning">Alterar</a>
                                </td>
                                <td>
                                    ...
                                    <a href="../controller/HospedeCTR.php?id_hosp=<?= $linha['id_hosp'] ?>" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
                            <?php
                        }
