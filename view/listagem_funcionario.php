        ...
        <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center" id="template-bg-3">
            <div class="card mb-5 p-5 bg-gradient text-white col-md-4 formlogin">
                <div class="card-header text-center">
                    <h3>Consulta e listagem - Funcionário</h3>
                </div>
                <table>
                    ...
                    <tbody>
                        <?php
                        $resultado = consulta_funcionario();
                        //   var_dump($resultado);
                        foreach ($resultado as $linha) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="funcionario.php?id_func=<?= $linha['id_func'] ?>" class="btn btn-warning">Alterar</a>
                                </td>
                                <td>
                                    ...
                                    <a href="../controller/FuncionarioCTR.php?id_func=<?= $linha['id_func'] ?>" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
                            <?php
                        }
