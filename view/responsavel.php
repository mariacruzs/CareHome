    ...
    <body class="imgfundo2">
        ...
        <div id="site">
            ...
            <form method="POST" action="../controller/ResponsavelCTR.php">
                <h4 class="text-center">Cadastro do Responsável</h4>
                <br>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="cel_resp" class="form-control phone-ddd-mask" id="cel_resp" required placeholder="Ex.: (00) 0000-0000">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <button type="submit" class="btn btn-primary" name="cadastrar_responsavel" id="cadastrar_responsavel">Cadastrar</button>
                </div>
            </form>
        </div>
